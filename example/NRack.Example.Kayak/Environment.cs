...
{ 
    ...
    public class Environment : IDictionary<string, object>
    {
        ...
        /// </summary>
        public Func<Func<ArraySegment<byte>, Action, bool>, Action<Exception>, Action, Action> Body
        {
            get { return Get<Func<Func<ArraySegment<byte>, Action, bool>, Action<Exception>, Action, Action>>(RequestBodyKey); }
